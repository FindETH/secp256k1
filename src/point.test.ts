...
describe('Point', () => {
  describe('add', () => {
    it('adds two points together', () => {
      ...
      const point = pointAdd(secp256k1, pointA, pointB);
    ...
    it('doubles a point if the points are the same', () => {
      ...
      const point = pointAdd(secp256k1, pointA, pointA);
      expect(point).toStrictEqual(pointDouble(secp256k1, pointA));
    });
  });
  ...
  describe('double', () => {
    it('doubles a point', () => {
      ...
      const point = pointDouble(secp256k1, pointA);
  ...
  describe('multiply', () => {
    ...
    it('returns the same point if the value is 1', () => {
      ...
      const point = pointMultiply(secp256k1, pointA, 1n);
